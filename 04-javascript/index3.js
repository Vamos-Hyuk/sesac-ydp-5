...
// typeof : 자료형을 확인할 수 있는 키워드    , 2가지 방법 다 가능
// - typeof x
// - typeof(x)
...
// 실습
const interest = ['tennis', 'footsal', 'coffee', 'youtube'];
const me = {
  name: '장혁',
  isCrew: true,
  job: 'developer',
...
// 브라우저 콘솔에서 파란색 숫자면 숫자, 검은색 숫자는 문자
...
// Not-A-Number(숫자가 아님) 개발하면서 자주 만날 오류 메세지(NaN)
